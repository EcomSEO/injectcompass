  ...
  return (
    <header className="border-b border-forest/10 bg-cream/95 backdrop-blur sticky top-0 z-40">
      <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between">
        <Link href="/" className="font-serif text-2xl text-pine font-semibold">
          InjectCompass
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm">
          ...
          <Link
            href="/newsletter"
            className="rounded-md bg-pine px-4 py-2 text-cream hover:bg-sage transition"
          >
            Get the guide
          </Link>
        </nav>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 bg-cream md:hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-forest/10">
            <span className="font-serif text-xl text-pine font-semibold">
              InjectCompass
            </span>
            <button
