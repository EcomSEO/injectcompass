...
export default function PrivacyPage() {
  return (
    <TrustPageTemplate title="Privacy Policy">
      ...
      <p>
        This Privacy Policy describes how InjectCompass (&ldquo;we,&rdquo;
        &ldquo;us,&rdquo; or &ldquo;our&rdquo;) collects, uses, and shares
        information when you visit injectcompass.com.
      </p>
      ...
      <p>
        ...
        privacy@injectcompass.com. We respond within 30 days.
      </p>

      <h2>6. Children</h2>
      <p>
        InjectCompass is not directed at children under 13. We do not
      ...
      <h2>10. Contact</h2>
      <p>Questions? Email privacy@injectcompass.com.</p>
    </TrustPageTemplate>
  );
}
