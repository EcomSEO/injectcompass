...
export const metadata: Metadata = pageMetadata({
  ...
  description: "The terms that govern your use of InjectCompass.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <TrustPageTemplate title="Terms of Service">
      ...
      <p>
        By accessing injectcompass.com (&ldquo;the Site&rdquo;), you agree to
        these Terms. If you don&apos;t agree, don&apos;t use the Site.
      </p>

      <h2>1. The Site is informational</h2>
      <p>
        InjectCompass publishes editorial content about non-toxic living,
      ...
      <p>
        ...
        InjectCompass or licensed to us. You may share excerpts with
      ...
      <p>
        To the maximum extent permitted by law, InjectCompass is not liable
      ...
      <h2>10. Contact</h2>
      <p>Questions about these Terms? Email hello@injectcompass.com.</p>
    </TrustPageTemplate>
  );
}
