...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "How affiliate links work on InjectCompass and what that means for you.",
...
export default function AffiliateDisclosurePage() {
  return (
    <TrustPageTemplate title="Affiliate Disclosure">
      <p>
        InjectCompass participates in affiliate programs. That means that
