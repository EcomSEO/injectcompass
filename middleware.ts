...
export const config = {
  ...
  //  - Route handlers we deliberately keep locale-free (sitemap, robots,
  //    llms.txt, OG/twitter images, icons). Those still pass through Next's
  //    normal routing because they live at app/ root.
  matcher: [
